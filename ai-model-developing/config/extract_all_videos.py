...
for mov_file in mov_files:
    ...
    # === KREIRAJ OUTPUT STRUKTURU ime_videa/images/train/ ===
...
# Ubacite skriptu u folder u kojem se nalaze svi videi,
# skripta sve video snimke podeli u frejmove, pravilo ih imenuje
# i rasporedi u nove foldere oblika: /ime_videa/images/train/frame_xxxxx.jpg